...
namespace Cryptographic_Application
{
    public partial class Form1 : Form
    {
        ...
        const string EncrFolder = @"D:\C Projects\Cryptographic Application\Cryptographic Application\bin\Debug\Encrypt\";
        const string DecrFolder = @"D:\C Projects\Cryptographic Application\Cryptographic Application\bin\Debug\Decrypt";
        const string SrcFolder = @"D:\C Projects\Cryptographic Application\Cryptographic Application\bin\Debug\docs";

        // Public key file
        const string PubKeyFile = @"D:\C Projects\Cryptographic Application\Cryptographic Application\bin\Debug\Encrypt\rsaPublicKey.txt";
        ...
        private void buttonExportPublicKey_Click(object sender, EventArgs e)
        {
            ...
            string p = @"D:\C Projects\Cryptographic Application\Cryptographic Application\bin\Debug\Encrypt\";
            using (var sw = new StreamWriter(p + KeyName , false))
            {
        ...
        private void buttonImportPublicKey_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                KeyName = openFileDialog1.SafeFileName;
